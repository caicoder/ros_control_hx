  ...
  void render(Canvas canvas) {
    ...
    try {
      ...
      if (parentComponent is PoseComponent) {
        ...
        // 绘制点位名称
        if (poseType != PoseType.robot && parentComponent.navPoint != null && parentComponent.navPoint!.name.isNotEmpty) {
          final textSpan = TextSpan(
            text: parentComponent.navPoint!.name,
          ...
          textPainter.paint(
            canvas,
            Offset(size / 2 - textPainter.width / 2, size / 2 + radius + 4),
          );
        }
      }
