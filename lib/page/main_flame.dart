...
class MainFlame extends FlameGame {
  ...
  Future<void> onLoad() async {
    ...
    // 监听navPointManager的更新
    navPointManager.addListener(() {
  ...
  void _updateTopologyLayers() {
    ...
    if (selectedPointType != 'All') {
      navPoints = navPoints.where((p) => p.type == selectedPointType).toList();
    }
  ...
  // 切换显示的导航点类型
  void setPointTypeFilter(String type) {
